...
export const addGridBackgroundToSvg = () => {
  ...
  gridRectBackground.setAttribute(
    "width",
    `${boardSvgWidth + gridLineThickness}px`,
  );
  gridRectBackground.setAttribute(
    "height",
    `${boardSvgHeight + gridLineThickness}px`,
  );
  gridRectBackground.setAttribute(
    "transform",
    `translate(${boardOffsetX * gridCellSize - gridLineThickness / 2} ${
      boardOffsetY * gridCellSize - gridLineThickness / 2
    })`,
  );
